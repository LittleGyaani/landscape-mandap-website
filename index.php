...
<html lang="en">
<head>
  <title>Landscape Mandap - Luxury of your Event</title>
  <?php
...
<body>
  ...
  <section class="probootstrap-slider flexslider">
    <ul class="slides">
      <li style="background-image: url(https://i.ytimg.com/vi/qmhsoY9IIwY/maxresdefault.jpg);" class="overlay">
        <div class="container">
          <div class="row">
        ...
        <div class="col-md-4">
          <div class="service left-icon probootstrap-animate">
            ...
            <div class="text">
              ...
              <p>Corporate meetings are a cornerstone of doing business and generating results. But where you choose to hold your meeting can make or break your meeting.</p>
              <p><a href="#" class="link-with-icon">Explore More <i class=" icon-chevron-right"></i></a></p>
            </div>
          </div>
        </div>
  ...
  <section class="probootstrap-half">
    ...
    <div class="text">
      <div class="probootstrap-animate fadeInUp probootstrap-animated">
        ...
        <p><img src="assets/images/curve_white.svg" class="seperator" alt="Free HTML5 Bootstrap Template"></p>
        <div class="row">
          <div class="col-md-6">
            <p>As a bespoke event management company, based in Bhubaneswar, offering inspiration, corporate conferencing and venue management services, Landscape Creations have the quality and qualified team to guarantee your event’s success. Our Event Managers expert in corporate event designing and planning, creative event production, stage management and audio-visual management for webinars.</p>
          </div>
          <div class="col-md-6">
            <p>Landscape Banquet Hall is a part of Landscape Creation. Landscape Creation the most active Entrainment Management Company in India, we are definitely the most Trendsetters in the Event Industry. Some of the most magnificent, breath-taking and unique event venues in Bhubaneswar. Whether you are looking to host a conference, marriage reception and party hall especially ac banquets we’ve got the venue for you.</p>
          </div>
        </div>
